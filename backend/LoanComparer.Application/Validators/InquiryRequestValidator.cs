...
public sealed class InquiryRequestValidator : AbstractValidator<InquiryRequest>
{
    public InquiryRequestValidator(LoanComparerContext context)
    {
        ...
        When(x => x.GovtId.Type == "Passport Number", () =>
        {
            RuleFor(x => x.GovtId.Value).
